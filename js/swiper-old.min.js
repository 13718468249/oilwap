...
!function (e, t) {
    ...
    var g = {
        loopCreate: function () {
            ...
            var _wid = document.getElementById("swip").clientWidth;
            a.append('<div class="swiper-slidea" style="width:'+_wid+'px"><img src="../images/second.png" style="width:'+_wid+'px"><div class="sli-pos"><p>Oilbank is a boon to<br>you!</p><p>We have many useful tools and calculators which may help you to calculate your cost, avoid risks and reduce the workload of operations.</p></div>')
        }, loopFix: function () {
